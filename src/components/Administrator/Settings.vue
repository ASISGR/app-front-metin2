<template>
    <label for="register-activation-setting">Register Activation: {{ registerActivation }}</label>
    <a-switch @change="registerChangeStatus" id="register-activation-setting" v-model:checked="registerActivation" />
    <br>
    <label for="register-required-email-setting">Register Email Activation: {{ registerRequiredEmailActivation }}</label>
    <a-switch @change="registerEmailChangeStatus" id="register-required-email-setting" v-model:checked="registerRequiredEmailActivation" />
...
<script lang="ts" setup>
  ...
  onMounted(() => {
    ...
    .then((response: any) => {
      ...
      registerRequiredEmailActivation.value = response.registerEmailActivationStatus;
    })
    .catch((err) => {
        console.log(err);
    });
